...
#define BUZZER_GPIO 34
#define LED_GREEN //integração define leds do semáforo
#define LED_YELLOW //integração define leds do semáforo
#define LED_RED //integração define leds do semáforo
